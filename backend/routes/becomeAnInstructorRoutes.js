...
router
  .route("/")
  .post(protect(["student"]), createInstructorRequest)
  .get(protect(["admin"]), getAllInstructorRequests);
router
  .route("/:id")
  .get(protect(["admin"]), getInstructorRequest)
  .patch(protect(["admin"]), updateInstructorRequest)
  .delete(protect(["admin"]), deleteInstructorRequest);
