...
import AdminCourseCard from "../components/Dashboard/AllCourses/AdminCourseCard";
...
const AdminCourses = () => {
  ...
  return (
    <section className="flex flex-col justify-center items-center gap-10 py-14">
      <div className="flex container justify-between items-center border border-gray-200 bg-white p-3">
      ...
      <div className="container grid grid-cols-1 gap-6 minmax-[15.25rem,1fr] md:grid-cols-2 lg:grid-cols-3 desktop:grid-cols-4 place-items-center">
        {newCourses
          .filter((course) =>
